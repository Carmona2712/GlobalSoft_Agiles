 ...
 */
public class Cambiar_Hora_Nocturna extends javax.swing.JFrame {

    Controlador_Horas ch = new Controlador_Horas();
    public Cambiar_Hora_Nocturna() {
        initComponents();
        CargarHora();
    }
    ...
    public void CargarHora(){
        ...
        String vn = String.valueOf(ch.REtornarHoraNocturna().getValor());
        txtNuevoValor.setText("0.0");
        txtValorActual.setText(vn);
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Valor Actual Hora Extra Nocturna");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (txtNuevoValor.getText().equals("0.0") || txtNuevoValor.getText().isEmpty()) {
            ...
            if(ch.ActualizarValorHoraNocturna(Float.parseFloat(txtNuevoValor.getText()))==1){
                CargarHora();
                JOptionPane.showMessageDialog(null,"Se actualizo correctamente el valor de la hora extra nocturna");
            }else{
                   JOptionPane.showMessageDialog(null,"Error al actualizar el valor de la hora extra nocturna");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cambiar_Hora_Nocturna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cambiar_Hora_Nocturna().setVisible(true);
            }
        });
    }
