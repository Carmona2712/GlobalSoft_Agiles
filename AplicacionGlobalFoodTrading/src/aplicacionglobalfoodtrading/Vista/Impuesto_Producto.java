 ...
 */
public class Impuesto_Producto extends javax.swing.JFrame {
    ...
    public Impuesto_Producto() {
     ...
     public void CrearTabla() {
        ...
        TablaImpuesto.setModel(modelo);
    }

    public void LimpiarTabla() {
        int filas = TablaImpuesto.getRowCount();
    ...
    public void CargarTabla() {
        ...
        ArrayList<Impuesto> li = new ArrayList();
        LimpiarTabla();
        li = ci.ListadoImpuesto();

        for (Impuesto i : li) {
            String datos[] = {i.getAbreviatura(), i.getDescripcion(),String.valueOf(i.getValor())};
            modelo.addRow(datos);
        }
    ...
    public void CargarForm(Impuesto i) {
        this.txtAbreviatura.setText(i.getAbreviatura());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (txtAbreviatura.getText().isEmpty() || txtDescripcion.getText().isEmpty()||txtValor.getText().isEmpty()) {
            ...
            i.setAbreviatura(txtAbreviatura.getText());
            i.setDescripcion(txtDescripcion.getText());
            i.setValor(Float.parseFloat(txtValor.getText()));
            int ex = ci.RegistrarImpuesto(i);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (txtAbreviatura.getText().isEmpty()) {
            ...
            Impuesto i = null;
            i = ci.RetornarImpuestoxCod(txtAbreviatura.getText());
            if (i == null) {
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if (txtAbreviatura.getText().isEmpty()) {
            ...
            int ex = ci.EliminarImpuesto(txtAbreviatura.getText());
            if (ex == 0) {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (TablaImpuesto.getSelectedRow() < 0) {
            JOptionPane.showMessageDialog(null, "Debe seleccionar un impuesto");
        } else {
            int f = TablaImpuesto.getSelectedRow();
            int c = 0;
            String cate = String.valueOf(TablaImpuesto.getValueAt(f, c));
            RegistroProductos.txtImpuesto.setText(cate);
            
            float valor = ci.RetornarValorxAbrev(cate);
                    
            float precio = Float.parseFloat(RegistroProductos.txtPrecio_neto_venta.getText());
            float precimp = precio + (precio*valor/100);
            
            
            
            if(RegistroProductos.txtOtroImp.getText().isEmpty()){
            RegistroProductos.txtPreciomasimp.setText(String.valueOf(precimp));    
            }else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Impuesto_Producto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Impuesto_Producto().setVisible(true);
            }
        });
    }
