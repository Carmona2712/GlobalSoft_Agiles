 ...
 */
public class Cambiar_Hora_Diurna extends javax.swing.JFrame {

    Controlador_Horas ch = new Controlador_Horas();

    public Cambiar_Hora_Diurna() {
        initComponents();
        CargarHora();
    }
    ...
    public void CargarHora() {
        ...
        String vn = String.valueOf(ch.REtornarHoraDiurna().getValor());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Valor Actual Hora Extra Diurna");
    ...
    private void btnActualizarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnActualizarActionPerformed
        ...
        if (txtNuevoValor.getText().equals("0.0") || txtNuevoValor.getText().isEmpty()) {
            ...
            if (ch.ActualizarValorHoraDiurna(Float.parseFloat(txtNuevoValor.getText())) == 1) {
                CargarHora();
                JOptionPane.showMessageDialog(null, "Se actualizo correctamente el valor de la hora extra Diurna");
            } else {
                JOptionPane.showMessageDialog(null, "Error al actualizar el valor de la hora extra Diurna");
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Cambiar_Hora_Diurna.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Cambiar_Hora_Diurna().setVisible(true);
            }
        });
    }
