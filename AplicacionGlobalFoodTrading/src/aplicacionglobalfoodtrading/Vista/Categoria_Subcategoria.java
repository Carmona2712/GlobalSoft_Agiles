...
import aplicacionglobalfoodtrading.Vista.RegistroProductos;
 ...
 */
public class Categoria_Subcategoria extends javax.swing.JFrame {
    ControladorCategoria cc = new ControladorCategoria();
    DefaultTableModel modelo = new DefaultTableModel();

    public Categoria_Subcategoria() {
        initComponents();
        CrearTabla();
        CargarTabla();
    ...
    public void CargarTabla() {
        ...
        LimpiarTabla();
        lc = cc.ListadoCategorias();
        
        for(Categoria c : lc){
            String datos[] = {c.getCodigo(),c.getCategoria()};
            modelo.addRow(datos);
        }
    ...
    public void CargarForm(Categoria c){
    ...
    private void initComponents() {
        ...
        jMenuItem1.setText("Seleccionar Categoria");
        ...
        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Gestion de Categorias", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Arial", 0, 14))); // NOI18N
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if(txtCodigo.getText().isEmpty()||txtCategoria.getText().isEmpty()){
            JOptionPane.showMessageDialog(null,"Debe Ingresar todos los campos de informacion");
                ...
                int ex = cc.RegistrarCategoria(c);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if(txtCodigo.getText().isEmpty()){
            ...
            Categoria c = null;
            c = cc.RetornarCategoriaxCod(txtCodigo.getText());
            if(c == null){
                JOptionPane.showMessageDialog(null, "No se encontro la categoria  a buscar");
            }else{
                CargarForm(c);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        if(txtCodigo.getText().isEmpty()){
            ...
            int ex = cc.EliminarCategoria(txtCodigo.getText());
            if(ex == 0){
                JOptionPane.showMessageDialog(null, "No se encontro la categoria  a buscar");
            }else{
                LimpiarForm();
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        if(txtCodigo.getText().isEmpty()){
            ...
            c.setCategoria(txtCategoria.getText());
            c.setCodigo(txtCodigo.getText());
            if(cc.ModificarCategoria(c)==1){
                LimpiarForm();
                CargarTabla();
                JOptionPane.showMessageDialog(null,"Se modifico correctamente la categoria !!!!");
            }else{
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if(TablaCategorias.getSelectedRow()<0){
            ...
            int f = TablaCategorias.getSelectedRow();
            int c = 0;
            
            String cate = String.valueOf(TablaCategorias.getValueAt(f, c));         
                 Subcategoria_Menu.txtfk_categoria.setText(cate);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Categoria_Subcategoria.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Categoria_Subcategoria().setVisible(true);
            }
        });
    }
