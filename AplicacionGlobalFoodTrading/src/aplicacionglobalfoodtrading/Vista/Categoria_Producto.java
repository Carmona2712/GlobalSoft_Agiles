 ...
 */
public class Categoria_Producto extends javax.swing.JFrame {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        if (TablaCategorias.getSelectedRow() < 0) {
            ...
            RegistroProductos.txtCategoriaform.setText(cate);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Categoria_Producto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Categoria_Producto().setVisible(true);
            }
        });
    }
