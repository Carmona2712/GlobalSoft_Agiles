 ...
 */
public class Lista_Proveedores_Productos extends javax.swing.JFrame {

    ControladorProveedor cp = new ControladorProveedor();
   DefaultTableModel modelo = new DefaultTableModel();
    public Lista_Proveedores_Productos() {
        initComponents();
        CrearTabla();
        CargarTabla();
    }
   ...
   public void CrearTabla(){
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ...
        if(TablaProveedor.getSelectedRow()<0){
            ...
            int c = 0;
            String codigo = TablaProveedor.getValueAt(f, c).toString();
            Proveedor p = cp.ProvedorxCodigo(codigo);
    ...
    private void jMenuItem2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem2ActionPerformed
        ...
        if(TablaProveedor.getSelectedRow()<0){
            ...
            int c = 1;
            String codigo = TablaProveedor.getValueAt(f, c).toString();
            RegistroProductos.txtProveedor.setText(codigo);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Lista_Proveedores_Productos.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Lista_Proveedores_Productos().setVisible(true);
            }
        });
    }
